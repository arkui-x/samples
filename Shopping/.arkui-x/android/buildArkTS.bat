...
set project_path=/Users/apple/Desktop/WorkFile/ArkUI-X2-SDK/sample/master/samples/Shopping
set ohpm_path=/Users/apple/ohpm/ohpm-1.2.5/bin/ohpm
set arkuiXSdkPath=/Users/apple/Library/ArkUI-X/Sdk/10/arkui-x
