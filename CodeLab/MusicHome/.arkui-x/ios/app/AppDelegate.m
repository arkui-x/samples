...
#define BUNDLE_NAME @"com.huawei.music.musichome"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    PhoneEntryAbilityViewController *mainView = [[PhoneEntryAbilityViewController alloc] initWithInstanceName:instanceName];
...
- (BOOL)handleOpenUrlWithBundleName:(NSString *)bundleName
    ...
    if ([moduleName isEqualToString:@"arkuix"] && [abilityName isEqualToString:@"EntryAbility"]) {
        ...
        PhoneEntryAbilityViewController *entryOtherVC = [[PhoneEntryAbilityViewController alloc] initWithInstanceName:instanceName];
        entryOtherVC.params = params;
        subStageVC = (PhoneEntryAbilityViewController *)entryOtherVC;
