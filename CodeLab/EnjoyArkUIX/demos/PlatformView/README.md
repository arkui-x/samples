...
|-PlatformViewPlatformViewAbilityActivity.java	   			// Android侧注册PlatformViewFactory类
|---platformview
...
|---/ios/app
|   |---PlatformViewPlatformViewAbilityActivity.m	         		// iOS侧注册PlatformViewFactory类
|---platformview
...
demos/PlatformView/src/main/ets
|---platformviewability
|---pages
|   |---index.ets                          			// 主页面
