...
#define BUNDLE_NAME @"com.example.oxhorncampus"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",BUNDLE_NAME, @"arkuix", @"EntryAbility"];
    ArkuixEntryAbilityViewController *mainView = [[ArkuixEntryAbilityViewController alloc] initWithInstanceName:instanceName];
...
- (BOOL)handleOpenUrlWithBundleName:(NSString *)bundleName
    ...
    if ([moduleName isEqualToString:@"arkuix"] && [abilityName isEqualToString:@"EntryAbility"]) {
        NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",bundleName, moduleName, abilityName];
        ArkuixEntryAbilityViewController *entryOtherVC = [[ArkuixEntryAbilityViewController alloc] initWithInstanceName:instanceName];
        entryOtherVC.params = params;
        subStageVC = (ArkuixEntryAbilityViewController *)entryOtherVC;
