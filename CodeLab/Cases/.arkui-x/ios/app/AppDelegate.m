...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",BUNDLE_NAME, @"phone", @"PhoneAbility"];
    PhonePhoneAbilityViewController *mainView = [[PhonePhoneAbilityViewController alloc] initWithInstanceName:instanceName];
...
- (BOOL)handleOpenUrlWithBundleName:(NSString *)bundleName
    ...
    if ([moduleName isEqualToString:@"phone"] && [abilityName isEqualToString:@"PhoneAbility"]) {
