...
set project_path=/Users/zhangxueming/Documents/demo/PlatformView
set ohpm_path=/Users/zhangxueming/Library/Huawei/ohpm/bin/ohpm
set arkuiXSdkPath=/Users/zhangxueming/Documents/sdk/arkui-x/5.0.0.240516/10/arkui-x
