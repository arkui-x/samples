...
#define BUNDLE_NAME @"com.example.hspui"
...
- (BOOL)application:(UIApplication*)app openURL:(NSURL*)url options:(NSDictionary<NSString*, id>*)options
{
    ...
    [self handleOpenUrlWithBundleName:bundleName moduleName:moduleName abilityName:abilityName params:params, nil];
                             ...
                             params:(NSString*)params, ... NS_REQUIRES_NIL_TERMINATION
{
    ...
    if ([moduleName isEqualToString:@"entry"] && [abilityName isEqualToString:@"EntryAbility"]) {
        NativeViewController* otherVC = [[NativeViewController alloc] init];
        subStageVC = (NativeViewController*)otherVC;
    }
