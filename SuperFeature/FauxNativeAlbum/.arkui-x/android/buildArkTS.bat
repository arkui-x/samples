...
set project_path=C:\Users\zhouqiaoqiao\Desktop\project\project
set ohpm_path=D:\software\ohcommandline-tools-windows-2.0.0.2\oh-command-line-tools\ohpm\bin\ohpm
set arkuiXSdkPath=D:\sdk\ArkuixSdk\11\arkui-x
