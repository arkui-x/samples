...
#import "Feature1Feature1AbilityViewController.h"
#import <libarkui_ios/StageApplication.h>

#define BUNDLE_DIRECTORY @"arkui-x"
#define BUNDLE_NAME @"com.example.mutimodules"
...
- (BOOL)handleOpenUrlWithBundleName:(NSString *)bundleName
    ...
    } else if ([moduleName isEqualToString:@"feature1"] && [abilityName isEqualToString:@"Feature1Ability"]) {
        NSString *instanceName = [NSString stringWithFormat:@"%@:%@:%@",bundleName, moduleName, abilityName];
        Feature1Feature1AbilityViewController *otherVC = [[Feature1Feature1AbilityViewController alloc] initWithInstanceName:instanceName];
        subStageVC = (Feature1Feature1AbilityViewController *)otherVC;
